	...
	<div class="navbar navbar-inverse navbar-fixed" role="navigation">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li> <a href="addStudent.php" data-toggle="modal">Add Student</a></li>
		...
		<div class="container">
			...
			<div class="page-header">
				<h1>Change Password </h1>
									...
									<form action="php/edit2.php" enctype="multipart/form-data" method="POST">
					...
					<div class="form-group">
							...
							<div class="form-group">
								...
								<div class="col-lg-3">
									<input type="text" class="form-control"  name="name" placeholder="Enter Name" style="width:300px;" value="" required>
							...
							<div class="form-group">
								<label for="contact-name" class="col-lg-3 control-label"> Edit password :</label>
								<div class="col-lg-3">
									<input type="password" class="form-control"  name="password" placeholder="Enter Password" style="width:300px;" value="<?php echo $password;?>" required>
								<!--inlabel whatever for="value" is should be same as id in input field  repeat div class form group for various 
									form context-->
								</div>
							</div><br><Br>
